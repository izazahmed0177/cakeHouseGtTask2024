...
// import Loading from "../shaerItem/Loading";
...
export default function UserDetels() {
  ...
  return (
    ...
    <div className="flex flex-col">
        ...
        src="https://img.freepik.com/free-photo/side-view-man-working-nature_23-2151205446.jpg?size=626&ext=jpg&uid=R81456783&ga=GA1.1.993543583.1715526194&semt=ais_user"
         alt="User Cover" className="w-full xl:h-[20rem] lg:h-[18rem] md:h-[16rem] sm:h-[14rem] xs:h-[11rem]" />
                {/* className="w-full " /> */}
        ...
        <>
        {
           ! user?.photoURL  ?
            <>
            <img src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?size=338&ext=jpg&ga=GA1.1.2082370165.1716854400&semt=sph" alt="User Profile"
            ...
            {/* <img src="https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw3fHxwZW9wbGV8ZW58MHwwfHx8MTcxMTExMTM4N3ww&ixlib=rb-4.0.3&q=80&w=1080" alt="User Profile"
                    className="rounded-md lg:w-[12rem] lg:h-[12rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[7rem] xs:h-[7rem] outline outline-2 outline-offset-2 outline-blue-500 relative lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]" /> */}
                    {/* // className="rounded-md outline outline-2 outline-offset-2 outline-blue-500 relative lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]" /> */}
            ...
            {/* <!-- FullName --> */}
              ...
              !user?.displayName ?
              <>
              <h1  className="w-full text-left my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">Avetor</h1>

              </>
              :
              <>
              <h1  className="w-full text-left my-4 sm:mx-4 xs:pl-4 text-gray-800 dark:text-white lg:text-4xl md:text-3xl sm:text-3xl xs:text-xl font-serif">{user?.displayName}</h1>
            ...
            <div className="w-full my-auto py-6 flex flex-col justify-center gap-2">
                    ...
                    <div className="w-full">
                        <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div className="flex flex-col pb-3">
                                ...
                                <dd className="text-lg font-semibold">Bangladesh, Dhaka</dd>
                            </div>
                ...
                <div className="my-10 lg:w-[70%] md:h-[14rem] xs:w-full xs:h-[10rem]">
                    ...
                    {/* <iframe
                        ...
                        src="https://maps.app.goo.gl/4evpPPGseLZ2gRLo7"
                        // className="rounded-lg w-full h-full" style="border:0;" allowfullscreen="" loading="lazy"
                        className="rounded-lg w-full h-full"   loading="lazy"
                       ></iframe> */}

<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d58438.002033053126!2d90.36039489031984!3d23.733998787039678!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sbn!2sbd!4v1716972018018!5m2!1sbn!2sbd"
