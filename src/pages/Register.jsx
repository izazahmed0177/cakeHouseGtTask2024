...
console.log(user,loading);
  ...
  return (
    ...
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-gray-500   text-white">
    ...
    <form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6">
      ...
      <div className="space-y-1 text-sm">
        ...
        <input type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" className="w-full px-4 py-3 rounded-md   border-gray-300   bg-gray-50   text-gray-800 focus:  border-violet-600" />
      </div>
...

{
  error && <p className="text-red-800">{error?.message}</p>
    ...
    <p className="text-xs text-center sm:px-6   text-white">You have an account?
      <a rel="noopener noreferrer" href="/login" className="underline hover:font-bold  text-white">Log in</a>
    </p>
  </div>
